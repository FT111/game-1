...
public class VelocityComponent extends Component {
    ...
    public double verticalMinMovementFrequencyMultiplier = 1.7; // Multiplier applied to maxMovementFrequency when moving vertically, typically more than one to keep visual movement speed consistent due to the rectangular grid
